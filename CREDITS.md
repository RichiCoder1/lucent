...
Consulted September 8, 2026 for the [style-driven layout discussion](docs/plans/style-driven-layout-draft.md): [CSS Conditional Rules Level 5](https://www.w3.org/TR/2026/WD-css-conditional-5-20260630/#container-queries) (W3C Working Draft, June 30, 2026) informs explicit query scope and size-containment boundaries; Microsoft's [WPF attached-property overview](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/properties/attached-properties-overview) informs the comparison with parent-consumed child placement. This is design research over Lucent's existing typed properties; no implementation is copied, and no CSS or WPF dependency is added.
