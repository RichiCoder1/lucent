...
{
    public LuiParameterSyntax(LuiSpan span, string typeText, LuiToken name, LuiToken separator) : base(span) { TypeText = typeText; Name = name; Separator = separator; }
    public string TypeText { get; } public LuiToken Name { get; } public LuiToken Separator { get; }
}
...
public sealed class LuiStyleWithSyntax : LuiValueSyntax { public LuiStyleWithSyntax(LuiSpan span, LuiToken outerOpenBrace, LuiToken name, LuiToken withKeyword, LuiToken openBrace, IReadOnlyList<LuiStyleAssignmentSyntax> assignments, LuiToken closeBrace, LuiToken outerCloseBrace) : base(span) { OuterOpenBrace = outerOpenBrace; Name = name; WithKeyword = withKeyword; OpenBrace = openBrace; Assignments = assignments; CloseBrace = closeBrace; OuterCloseBrace = outerCloseBrace; } public LuiToken OuterOpenBrace { get; } public LuiToken Name { get; } public LuiToken WithKeyword { get; } public LuiToken OpenBrace { get; } public IReadOnlyList<LuiStyleAssignmentSyntax> Assignments { get; } public LuiToken CloseBrace { get; } public LuiToken OuterCloseBrace { get; } }
...
public sealed class LuiVariantGroupSyntax : LuiStyleMemberSyntax { public LuiVariantGroupSyntax(LuiSpan span, LuiToken whenKeyword, LuiToken name, LuiToken openBrace, IReadOnlyList<LuiStyleAssignmentSyntax> assignments, LuiToken closeBrace) : base(span) { WhenKeyword = whenKeyword; Name = name; OpenBrace = openBrace; Assignments = assignments; CloseBrace = closeBrace; } public LuiToken WhenKeyword { get; } public LuiToken Name { get; } public LuiToken OpenBrace { get; } public IReadOnlyList<LuiStyleAssignmentSyntax> Assignments { get; } public LuiToken CloseBrace { get; } }
