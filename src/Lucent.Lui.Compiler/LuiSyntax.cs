...
public sealed class LuiStyleWithSyntax : LuiValueSyntax { public LuiStyleWithSyntax(LuiSpan span, LuiToken outerOpenBrace, LuiToken name, LuiToken withKeyword, LuiToken openBrace, IReadOnlyList<LuiStyleMemberSyntax> members, LuiToken closeBrace, LuiToken outerCloseBrace) : base(span) { OuterOpenBrace = outerOpenBrace; Name = name; WithKeyword = withKeyword; OpenBrace = openBrace; Members = members; Assignments = members.SelectMany(member => member is LuiStyleAssignmentSyntax assignment ? new[] { assignment } : ((LuiVariantGroupSyntax)member).Assignments).ToArray(); CloseBrace = closeBrace; OuterCloseBrace = outerCloseBrace; } public LuiToken OuterOpenBrace { get; } public LuiToken Name { get; } public LuiToken WithKeyword { get; } public LuiToken OpenBrace { get; } public IReadOnlyList<LuiStyleMemberSyntax> Members { get; } public IReadOnlyList<LuiStyleAssignmentSyntax> Assignments { get; } public LuiToken CloseBrace { get; } public LuiToken OuterCloseBrace { get; } }
