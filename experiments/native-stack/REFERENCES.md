...
| [SDL3](https://github.com/libsdl-org/SDL) | zlib | Cross-platform window, input, clipboard, display-scale, text-composition services, and official C# binding baseline | Runtime dependency candidate |
| [SDL3-CS](https://github.com/edwardgushchin/SDL3-CS) | zlib | Managed SDL3 bindings and platform-window properties | Provisional runtime dependency; compare with official bindings in Milestone 1 |
