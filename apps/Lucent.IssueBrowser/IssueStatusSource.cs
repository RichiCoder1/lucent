...
{
    Task<IssueStatusSaveOutcome> SaveAsync(
        int issueNumber,
        string status,
...
public sealed class FixtureIssueStatusSource : IIssueStatusSource
{
    ...
    )
    {
        ...
        IssueStatusSaveOutcome outcome = (issueNumber % 3) switch
        {
            ...
            1 when _transientFailures.Add(issueNumber) =>
                new IssueStatusSaveOutcome.TransientFailure(
                    "Fixture source is temporarily unavailable."
                ),
