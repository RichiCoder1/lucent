...
public static class IssueBrowserStructure
{
    ...
    private static Theme Palette(
        ...
        controls
            .Set(PageSurface, (Brush)surface)
            .Set(PageForeground, foreground)
            .Set(HeaderSurface, (Brush)header)
            .Set(RowSurface, (Brush)row)
            .Set(FocusSurface, (Brush)focus)
            .Set(FocusForeground, focusForeground)
            .Set(DensityHeaderHeight, density == IssueDensity.Comfortable ? 84f : 68f)
            .Set(DensityFilterHeight, density == IssueDensity.Comfortable ? 28f : 22f)
            .Set(DensitySpacing, density == IssueDensity.Comfortable ? 8f : 4f)
            .Set(DensityFontSize, density == IssueDensity.Comfortable ? 14f : 12f)
            .Set(DensityTitleFontSize, density == IssueDensity.Comfortable ? 18f : 16f);
