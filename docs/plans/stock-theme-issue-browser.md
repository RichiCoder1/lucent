...
The design pass exposed the wrapped-row auto-height issue corrected in [#108](https://github.com/RichiCoder1/lucent/issues/108): nested auto-sized ancestors now receive the wrapped height at the constrained width. The accepted [style-driven layout design](style-driven-layout.md) moves Issue Browser's adaptive arrangement into parameterized styles while retaining its panes across width changes. The stock-theme constraints continue to apply.
