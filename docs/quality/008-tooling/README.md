...
On the recorded Windows/.NET 9 reference machine, the final p95 was 0.1971 ms
for warm completion and 71.1093 ms for edit-plus-completion. The corresponding
p95 allocations were 17,792 and 12,090,816 bytes. These are below the Plan 008
