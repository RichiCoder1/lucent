...
On the recorded Windows/.NET 9 reference machine, the final p95 was 0.1805 ms
for warm completion and 51.9855 ms for edit-plus-completion. The corresponding
p95 allocations were 17,056 and 8,441,112 bytes. These are below the Plan 008
